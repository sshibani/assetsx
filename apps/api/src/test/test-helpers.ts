...
const schemaStatements = [
  `CREATE TABLE IF NOT EXISTS "User" ("id" TEXT NOT NULL PRIMARY KEY,"email" TEXT NOT NULL,"passwordHash" TEXT,"globalRole" TEXT NOT NULL DEFAULT 'user',"locale" TEXT NOT NULL DEFAULT 'en',"avatarStorageKey" TEXT,"createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,"updatedAt" DATETIME NOT NULL)`,
  `CREATE TABLE IF NOT EXISTS "Account" ("id" TEXT NOT NULL PRIMARY KEY,"name" TEXT NOT NULL,"slug" TEXT NOT NULL,"status" TEXT NOT NULL DEFAULT 'active',"plan" TEXT NOT NULL DEFAULT 'trial',"storageQuotaBytes" BIGINT,"createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,"updatedAt" DATETIME NOT NULL)`,
  `CREATE TABLE IF NOT EXISTS "AccountSettings" ("id" TEXT NOT NULL PRIMARY KEY,"accountId" TEXT NOT NULL,"dateTimeFormat" TEXT NOT NULL DEFAULT 'ISO',"timezone" TEXT NOT NULL DEFAULT 'UTC',"brandColor" TEXT NOT NULL DEFAULT '#343ced',"logoStorageKey" TEXT,"typeface" TEXT,"createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,"updatedAt" DATETIME NOT NULL,CONSTRAINT "AccountSettings_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "Account" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`,
  ...
  `CREATE TABLE IF NOT EXISTS "AccountMembership" ("id" TEXT NOT NULL PRIMARY KEY,"accountId" TEXT NOT NULL,"userId" TEXT NOT NULL,"role" TEXT NOT NULL,"status" TEXT NOT NULL DEFAULT 'active',"lastActiveAt" DATETIME,"createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,"updatedAt" DATETIME NOT NULL,CONSTRAINT "AccountMembership_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "Account" ("id") ON DELETE CASCADE ON UPDATE CASCADE,CONSTRAINT "AccountMembership_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`,
  ...
  `CREATE TABLE IF NOT EXISTS "AssetTag" ("id" TEXT NOT NULL PRIMARY KEY,"assetId" TEXT NOT NULL,"tag" TEXT NOT NULL,"createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,CONSTRAINT "AssetTag_assetId_fkey" FOREIGN KEY ("assetId") REFERENCES "Asset" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS "AssetTag_assetId_tag_key" ON "AssetTag"("assetId", "tag")`,
  `CREATE INDEX IF NOT EXISTS "AssetTag_assetId_idx" ON "AssetTag"("assetId")`,
  `CREATE INDEX IF NOT EXISTS "AssetTag_tag_idx" ON "AssetTag"("tag")`,
